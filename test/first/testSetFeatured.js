...
export default async function testSetFeatured() {
  console.log("Starting test for setFeatured...");
  ...
  const payload = {
    ...
    expectedVersion: 3, // replace with the correct version if needed
    featured: true, // toggle this between true or false to test both
    actorUserId: 42,
  };

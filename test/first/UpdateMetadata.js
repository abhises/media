...
export default async function testUpdateMetadata() {
  console.log("Starting test for updateMetadata...");
  ...
  // ---------------------------------
  // ⚙️ Step 2: Prepare payload for update
  // ---------------------------------
  const payload = {
    ...
    featured: true,
    coming_soon: false,
    image_variants_json: JSON.stringify({ variant1: "url1" }),
    gallery_poster_url: "http://example.com/poster.jpg",
    media_meta: JSON.stringify({ duration: 120 }),
    actorUserId: 99,
  };
